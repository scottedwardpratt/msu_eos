...
\begin{enumerate}\itemsep=0pt
        ...
        \left.\frac{d\epsilon^{\rm(gas)}}{dT}\right|_{\vec{\rho}}&=\left.\frac{d\epsilon^{\rm(gas)}}{dT}\right|_{\vec{\mu}}-\zeta^{\rm(gas)}_a\chi^{-1{\rm(gas)}}_ab\zeta^{\rm(gas)}_b.
        \end{align*}
        ...
        \end{align*}
        along with $d\epsilon^{\rm(gas)}/d\rho_a$.
        \item Add quantities to get quantities for the combined parts,
        \begin{align*}
        \epsilon&=\epsilon^{\rm(gas)}+\epsilon^{\rm(int)},\\
        P&=P^{\rm(gas)}+P^{\rm(int)},\\
